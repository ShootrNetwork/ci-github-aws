...
docker run -v /Users/arturo/git/shootr-backend:/ci -d -t fav24/java8-ci bash
...
#ci-github-aws --c test_and_build  --git-commit a1234b567 --git-branch 'dev-'
...
ci-github-aws --c deploy          --git-commit a1234b567 --git-branch 'dev-'
